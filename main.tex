...
\section{Introduction}
    ...
    % \bloc{controle}{controle}
    % \bloc{mouvement}{mouvement}
    % \bloc{apparence}{apparence}
    % \bloc{sons}{sons}
    % \bloc{stylo}{stylo}
    % \bloc{capteurs}{capteurs}
    % \bloc{operateurs}{operateurs}
    % \bloc{ajouterblocs}{ajouterblocs}

% \begin{pspicture}(0,0)(4,6)%
  % \psset{unit=3}
  % \pspolygon[linewidth=2pt,linecolor=green,fillcolor=green,fillstyle=solid](0.08,0.4)(0.2,1)(0.2,0.95)(0.3,0.9)(0.4,0.88)(0.5,0.88)(0.7,0.92)(0.7,0.65)(0.5,0.6)(0.4,0.6)(0.3,0.65)(0.14,0.69)
% \end{pspicture}%
...
\begin{pspicture}(0,0)(4,-17)%
    \drapeau
    \bloc{stylo}{effacer tout}
    \bloc{stylo}{stylo en position d'écriture}
    \bloc{stylo}{mettre la taille du stylo à \field{1}}
    \begin{boucle}{répéter \field{240} fois}
      \begin{boucle}{répéter \field{4} fois}
        \bloc{mouvement}{avancer de \field{100}}
        \bloc{mouvement}{tourner de \field*{90} degrés}
      \end{boucle}
      \bloc{mouvement}{tourner de \field{1.5} degrés}
      \bloc{stylo}{ajouter \field{1} à la couleur du stylo}
    \end{boucle}
\end{pspicture}%
\end{document}
